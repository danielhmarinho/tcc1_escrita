...
\subsection{Práticas para apenas um desenvolvedor}
...
A próxima seção trará uma visão geral sobre os Pontos de Função e sua utilização para medição de tamanho funcional de software.

...
\hline
\multicolumn{1}{|l|}{}                                                                                        & \multicolumn{4}{l|}{\textbf{DER - Dados Elementares Referenciados}}                      \\ \hline
\multirow{4}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}RLR – Registros\\  Lógicos \\ Referenciados\end{tabular}}} &                        & \textbf{\textless20} & \textbf{20-50} & \textbf{\textgreater50} \\ \cline{2-5}
                                                                                                              & \textbf{1}             & Baixa                & Baixa          & Média                   \\ \cline{2-5}
                                                                                                              & \textbf{2-5}           & Média                & Média          & Alta                    \\ \cline{2-5}
...
\begin{table}[H]
\centering
\caption{Determinar Valor de Funções de Dados}
\label{pontuacaofuncoesdedados}
\begin{tabular}{|l|l|l|l|}
\hline
                                                                                        & \textbf{Baixa} & \textbf{Média} & \textbf{Alta} \\ \hline
\textbf{\begin{tabular}[c]{@{}l@{}}Arquivos Lógicos \\ Internos (ALI)\end{tabular}}     & 7PF            & 10PF           & 15PF          \\ \hline
\textbf{\begin{tabular}[c]{@{}l@{}}Arquivos de Interface \\ Externa (AIE)\end{tabular}} & 5PF            & 7PF            & 10PF          \\ \hline
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{Determinar Complexidade de Funções de Transação(EE - Entrada Externa)}
...
Consultando as tabelas presente na seção anterior, podemos definir a complexidade de todas estas funções como baixas. Agora basta somar a pontuação obtida e somara as funções de dados e as funções de transação para o tamanho total em pontos de função. Nesta exemplo teremos a seguinte soma:

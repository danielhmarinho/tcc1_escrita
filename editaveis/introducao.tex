...
O desenvolvimento de software, neste caso de uma ferramenta livre, segue metodologias e processos estruturados para a organização de um time de desenvolvedores.
...
\textbf{APF PRIME Ligtht}                                                             &                               & X                                                                                 &                             &                              \\ \hline
\end{tabular}
}
\end{table}
